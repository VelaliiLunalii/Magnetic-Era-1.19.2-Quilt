...
public class ModBlocks {
	...
	public static final Block COPPER_COIL = new CoilBlock(QuiltBlockSettings.copyOf(Blocks.COPPER_BLOCK).nonOpaque());
	public static final Block WEAK_COPPER_COIL = new CoilBlock(QuiltBlockSettings.copyOf(Blocks.COPPER_BLOCK).nonOpaque());
	public static final Block STRONG_COPPER_COIL = new CoilBlock(QuiltBlockSettings.copyOf(Blocks.COPPER_BLOCK).nonOpaque());
	...
	public static final Block PHASE_WIRE_BLOCK = new AxisBlock(QuiltBlockSettings.copyOf(Blocks.IRON_BLOCK));
	public static final Block COPPER_WIRE = new WireBlock(QuiltBlockSettings.copyOf(Blocks.COPPER_BLOCK).nonOpaque().strength(0.1F));
	public static final Block PHASE_WIRE = new WireBlock(QuiltBlockSettings.copyOf(Blocks.IRON_BLOCK).nonOpaque().strength(0.1F));
	...
	public static void register(ModContainer mod) {
		...
		Registry.register(Registry.BLOCK, new Identifier(mod.metadata().id(), "phase_wire_block"), PHASE_WIRE_BLOCK);
		Registry.register(Registry.ITEM, new Identifier(mod.metadata().id(), "phase_wire_block"),
			new BlockItem(PHASE_WIRE_BLOCK, new QuiltItemSettings().group(ModItemGroups.MAGNETIC_ERA_GROUP)));
