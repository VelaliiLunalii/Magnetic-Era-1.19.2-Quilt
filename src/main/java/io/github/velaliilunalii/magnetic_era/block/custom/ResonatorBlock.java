...
public class ResonatorBlock extends BlockWithEntity {
	...
	public void appendTooltip(ItemStack itemStack, BlockView world, List<Text> tooltip, TooltipContext tooltipContext) {
		if (Screen.hasShiftDown()) {
			tooltip.add(Text.translatable("block.magnetic_era.resonator.tooltip.shift").styled(style -> style.withItalic(true)).formatted(Formatting.GRAY));
		}else {
			tooltip.add(Text.translatable("block.magnetic_era.resonator.tooltip").styled(style -> style.withItalic(true)).formatted(Formatting.GRAY));
