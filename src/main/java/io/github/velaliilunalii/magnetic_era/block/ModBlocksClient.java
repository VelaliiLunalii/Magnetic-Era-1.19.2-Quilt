...
public class ModBlocksClient {
	public static void register(ModContainer mod) {
		BlockRenderLayerMap.INSTANCE.putBlock(MAGNETIC_COIL, RenderLayer.getTranslucent());
		BlockRenderLayerMap.INSTANCE.putBlock(WEAK_MAGNETIC_COIL, RenderLayer.getTranslucent());
		BlockRenderLayerMap.INSTANCE.putBlock(STRONG_MAGNETIC_COIL, RenderLayer.getTranslucent());
