...
public class IronCapacitorBlock extends CopperCapacitorBlock {

	public IronCapacitorBlock(Settings settings, int maxCharge) {
	...
	public BlockEntity createBlockEntity(BlockPos pos, BlockState state) {
		return new IronCapacitorBlockEntity(pos, state);
	}

	@Nullable
	@Override
	public <T extends BlockEntity> BlockEntityTicker<T> getTicker(World world, BlockState state, BlockEntityType<T> type) {
		return checkType(type, ModBlockEntities.IRON_CAPACITOR_BLOCK_ENTITY,
